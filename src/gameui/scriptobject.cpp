...
CScriptListItem::CScriptListItem( char const *strItem, char const *strValue, const char *userText ) : 
	CScriptListItem( strItem, strValue )
{
	Q_strncpy( szUserText, userText, sizeof( szUserText ) );
}
